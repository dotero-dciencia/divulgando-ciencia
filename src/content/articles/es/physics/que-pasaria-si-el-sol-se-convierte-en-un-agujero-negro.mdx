...
<Latex formula='\frac{M\_{Tierra}\cdot v^2}{r}<G\cdot\frac{M_{Tierra}\cdot M\_{AgujeroNegro}}{r^2}'/>
...
<Latex formula='F\_{Grav}=G\frac{M\_{AgujeroNegro}\cdot m\_{Tierra}}{r^2}'/>

*Fórmula de la gravitación universal*

<Latex formula='F\_{Grav}=m\_{Tierra}\times a \to a=\frac{m\_{Tierra}}{F\_{Grav}}'/>

*Segunda ley de Newton*

<Latex formula='a=\frac{G\frac{M\_{AgujeroNegro}\cdot m\_{Tierra}}{r^2}}{m\_{Tierra}}\to a=\frac{G\cdot M\_{AgujeroNegro}}{r^2}'/>
...
<Latex formula='g\_{AgujeroNegro}=\frac{6.67\cdot 10^{-11}\times 4.6914\cdot 10^{35}}{r^2}=\frac{3.1292\cdot 10^{25}}{r^2}'/>
...
<Latex formula='a\_{Tierra}=\frac{3.1292\cdot 10^{25}}{149597870700^2}=1398.2425'/>
...
<Latex formula='d=d\_0+v\_0t+\frac{1}{2}at^2'/>
...
<Latex formula='T\_{Caida}=\int\_{r\_{Final}}^{r\_{Inicial}}\frac{dx}{\sqrt{2GM\_{AgujeroNegro}\left( \frac{1}{r}-\frac{1}{r\_0} \right)}}'/>
...
<Latex formula='T\_{Caida}=\frac{\pi}{2}\sqrt{\frac{r\_0^3}{2GM\_{AgujeroNegro}}}=\frac{\pi}{2}\sqrt{\frac{r\_0^3}{6.2584\cdot10^{25}}}'/>
...
<Latex formula='T\_{CaidaTierra}=\frac{\pi}{2}\sqrt{\frac{149597870700^3}{6.2584\cdot10^{25}}}=11488.91'/>

### Tiempo de caída de otros planetas

Para ello usamos la fórmula:

<Latex formula='T\_{Caida} = \frac{\pi}{2}\sqrt{\frac{(149597870700 \times d\_{UA})^3}{6.2584\cdot 10^{25}}}'/>
