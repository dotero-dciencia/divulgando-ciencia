...
#### Diagrama de flujo: aprendizaje por prueba y error

Podemos verlo claramente en el siguiente diagrama de flujo:
...
Esta compañía investiga sobre el desarrollo de la inteligencia artificial y tiene como objetivo desarrollar nuevas inteligencias artificiales, de hecho, ha desarrollado algunas inteligencias artificiales muy conocidas últimamente, como ChatGPT, Dall·E 2 o Codex.
...
Pero, como toda I. A., está en proceso de aprendizaje y da respuestas que a veces no son acertadas, como en el siguiente caso, donde, cualquier persona que sepa programar en Python sería capaz de decir que el programa es un error, pero ChatGPT no, y plantea el programa suponiendo que la tercera línea de código no está comentada.
...
En el siguiente ejemplo pedimos a esta I. A. un aguacate con brazos y nos da cuatro imágenes de aguacates con brazos.

#### Codex

Hagamos un repaso: ChatGPT era una I. A. que nos respondía a una entrada de forma escrita, dándonos la solución más precisa; Dall·E 2 nos respondía con una imagen, viendo todas las imágenes de Internet y tratando de hacer una que se adecúe a la entrada; Codex, la I. A. que vamos a comentar ahora, nos responde con un trozo de código a lo que le pidamos.

En el siguiente ejemplo le pedimos que nos dibuje en JavaScript un círculo azul en el centro de la pantalla. Este es el resultado:
...
Aquí le pido que me cree una presentación sobre las Altas Capacidades. Este es el resultado:

### abbrevia.me

Esta I. A. es relativamente nueva, pues su función es crear una breve descripción sobre un perfil de Twitter, basándose en qué es lo que publica esta cuenta, con quién interactúa, a quién sigue…

Aunque acaba de volverse famosa, tal y como nos informa su creador, Jordi, aquí, la web va a cerrar dentro de poco tiempo.
...
Antes de terminar, quiero deciros que Google ya está tratando de sacar su propia inteligencia: Google Bard, de la que hablamos en este artículo. También hicimos una competición entre ChatGPT (GPT-3.5) y Rafa en Pasapalabra que publicamos en este artículo, ¿quién crees que ha ganado?

Tal es el avance constante de la inteligencia artificial que, mientras la realización de este artículo, algunos puntos se han quedado obsoletos y los hemos tenido que actualizar, es por ello que dentro de muy poco tiempo es probable que se quede obsoleto, pero si os gusta, próximamente podemos publicar nuevos artículos sobre I. A.